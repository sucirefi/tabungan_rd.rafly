...
<div class="panel-body">  
                ...
                <form action="<?php echo base_url('transaksi/simpan'); ?>" id="form" class="form-horizontal" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                        <select name="nasabah" class="form-control gaya">
                     ...
                     ?>
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-9">
                        <input type="text" name="user" class="form-control gaya" value="<?=$this->session->userdata('nama')?>" readonly>
                        </div>
                      </div>
