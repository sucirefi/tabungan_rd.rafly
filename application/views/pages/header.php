...
<body class="hold-transition skin-blue sidebar-mini fixed global-huruf">
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-mini global-huruf">UKS</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg global-huruf">Poliklinik</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="system/logout-cek.php" class="btn btn-default btn-flat" name="logout">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
